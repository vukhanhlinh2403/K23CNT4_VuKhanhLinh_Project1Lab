                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('vkluser.vklshow', $SanPham->id) }}" class="btn btn-primary btn-sm">Xem Chi Tiết</a>
                            <a href="{{route('vkluser.vkllogin')}} "   
                               class="btn btn-success btn-sm" 
                              >
                                <i class="fa fa-shopping-cart"></i> Mua
                            </a>

                            <a href="{{route('vkluser.vkllogin')}}"><button type="button" class="btn btn-warning btn-sm add-to-cart-btn" data-id="{{ $SanPham->id }}" data-name="{{ $SanPham->vklTenSanPham }}">
